      ...
      <aside className="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
        <div className="sidenav-header">
          ...
          <Link className="navbar-brand m-0" to="/">
            <AccountTreeIcon sx={{color:'#358FED', marginRight:'10px'}} />
            <span className="ms-1 font-weight-bold text-white">FYP-1</span>
          </Link>
        </div>
        ...
        <div className="collapse navbar-collapse  w-auto  " id="sidenav-collapse-main">
          <ul className="navbar-nav">
            <li className="nav-item">
              <Link className="nav-link text-white active bg-gradient-primary" to="./dashbord">
...

            {
              [
                ...
                {
                  label: 'Profile',
                  link: '/dashbord/profile',
                  icon: 'dashboard'
                },
                {
                  label: 'Billing',
                  link: '/dashbord/billing',
                  icon: 'receipt_long'
                },
                {
                  label: 'My Products',
                  link: '/dashbord/listedProducts',
                  icon: 'view_in_ar'
                },
                {
                  label: 'Sign Up',
                ...
                return (
                  <li className="nav-item">
                    <Link className="nav-link text-white" to={obj.link}>
                      <div className="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i className="material-icons opacity-10">{obj.icon}</i>
                      </div>
                      <span className="nav-link-text ms-1">{obj.label}</span>
                    </Link>
                  </li>
                )
              })
