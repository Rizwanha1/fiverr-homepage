                        ...
                        <div className="row align-items-center justify-content-lg-between">
                            ...
                            <div className="col-lg-6">
                                <ul className="nav nav-footer justify-content-center justify-content-lg-end">
                                    <li className="nav-item">
                                        <Link to="/" className="nav-link text-muted" target="_blank">Creative Tim</Link>
                                    </li>
                                    <li className="nav-item">
                                        <Link to="/" className="nav-link text-muted" target="_blank">About Us</Link>
                                    </li>
                                    <li className="nav-item">
                                        <Link to="/" className="nav-link text-muted" target="_blank">Blog</Link>
                                    </li>
                                    <li className="nav-item">
                                        <Link to="/" className="nav-link pe-0 text-muted" target="_blank">License</Link>
                                    </li>
                                </ul>
                            </div>
                        </div>
