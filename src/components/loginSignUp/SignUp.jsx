...
export default ({ openSignUp, setopenSignUp }) => {
                    ...
                    <DialogContentText>
                        <Box component='form' onSubmit={getData}>
                            ...
                            <Link to={'/dashbord'} style={{ textDecoration: 'none' }}>
                                <Button onClick={()=> setopenSignUp(false)}  fullWidth type='submit' sx={{ margin: '20px auto', padding: '10px 0px', background: '#1E1E1E', border: '1px solid #E4E5E7', color: 'gray', '&:hover': { background: '#110026' } }} >
                                    <span>Continue</span>
                                </Button>
                            </Link>
                            <Typography >
